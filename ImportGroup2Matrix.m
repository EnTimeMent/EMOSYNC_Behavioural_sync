function Triad7Group1 = ImportGroup2Matrix(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TRIAD7GROUP1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   TRIAD7GROUP1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Triad7Group1 = importfile('Triad7_Group1.csv', 11, 3010);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2021/02/04 17:22:48
...
Triad7Group1 = [dataArray{1:end-1}];
