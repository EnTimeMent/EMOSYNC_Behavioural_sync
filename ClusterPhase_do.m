function [GRPrhoM INDrhoM INDrpM TSrhoGRP TSrpIND] = ClusterPhase_do(TSfilename, TSnumber, TSfsamp, TSlsamp, TSsamplerate, plotflag,TITLE)
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
%   ClusterPhase_do.m
%
